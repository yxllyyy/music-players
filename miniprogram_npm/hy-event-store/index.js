...
__DEFINE__(1642811652638, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1642811652639,"./event-store":1642811652640}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1642811652639, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1642811652640, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1642811652639,"./utils":1642811652641}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1642811652641, function(require, module, exports) {
...
return __REQUIRE__(1642811652638);
})()
